...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      $data->save();
      return redirect('employee/create')->with('msg','Data Has Bee Submitted!');
  }
    ...
    public function update(Request $request, $id)
    {
      ...
      $data->status=$request->status;
      $data->save();
      return redirect('employee/create')->with('msg','Data Has Bee Updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('employee')->with('msg','Data Has Bee Deleted!');;
    }
}
